...
The full-length README originally shipped with this repository was retained here so nothing is lost after trimming the root README.  It walks through every agentic pattern, diagram and advanced feature demonstrated in the code-base.
