...
Configuration in [`src/app/agentConfigs/simpleHandoff.ts`](src/app/agentConfigs/simpleHandoff.ts)
```typescript
...
// Handoffs are set after construction to allow circular references between agents.
