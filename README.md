...
- Sequential Handoff: Specialist agents transfer the user between them based on intent.
...
- Prefer the realtime-mini models for low-latency voice; escalate tough tasks to stronger text models when needed.
