...
This repo demonstrates advanced patterns for building realtime voice agents using the OpenAI Realtime API together with the OpenAI Agents SDK. It includes two production-friendly architectures you can copy and adapt: a "Chat Supervisor" pattern and a "Sequential Handoff" pattern.
